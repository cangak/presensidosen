...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-view box box-primary">
    <div class="box-header">
        <?= "<?= " ?>Html::a(<?= $generator->generateString('Kembali') ?>, ['index', <?= $urlParams ?>], ['class' => 'btn btn-danger btn-flat']) ?>
        <?= "<?= " ?>Html::a(<?= $generator->generateString('Ubah') ?>, ['update', <?= $urlParams ?>], ['class' => 'btn btn-primary btn-flat']) ?>
